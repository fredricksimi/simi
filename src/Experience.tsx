    ...
    <>
      <main style={{ marginTop: "150px", marginRight: "" }} id="aboutsection">
        <p>
          ...
          technology, from simply cropping a photo to something as sophisticated
        ...
        <p>
          ...
          responsibilities include teaching Python and SQL, offering support to
          students via Slack, and mentoring them on their career journeys.
        </p>
      </main>
        ...
        <div>
          <div className="row p-3 hoverdiv">
            ...
            <div className="col-8">
              ...
              <p className="pt-2">
                <span className="badge py-1 px-3 mx-1 mb-2" style={skillStyle}>
                  Python
                </span>
                <span className="badge py-1 px-3 mx-1 mb-2" style={skillStyle}>
                  JavaScript
          ...
          <div className="row mt-5 p-3 hoverdiv">
            ...
            <div className="col-8">
              ...
              <p style={descStyle}>
                ...
                the educational consultancy firm's online platform, ensuring its
                stability and scalability.
              </p>
              <p style={descStyle}>
                Implemented custom business logic and algorithms to support the
                firm's core functionalities.
              </p>
              <p className="pt-2">
                <span className="badge py-1 px-3 mx-1 mb-2" style={skillStyle}>
                  Git
          ...
          <div className="row mt-5 p-3 hoverdiv">
            ...
            <div className="col-8">
              ...
              <p style={descStyle}>
                ...
                Organization. Contributed to the development of new features and
                improvements to existing ones, based on user feedback and
                analytics.
              </p>
              <p style={descStyle}>
                Ensured website accessibility and compliance with web standards
                and regulations.
              </p>
              <p className="pt-2">
                <span className="badge py-1 px-3 mx-1 mb-2" style={skillStyle}>
          ...
          <div className="row mt-5 p-3 hoverdiv">
            ...
            <div className="col-8">
              ...
              <p style={descStyle}>
                ...
                providing constructive feedback to colleagues and incorporating
                feedback into future development efforts.
              </p>
              <p className="pt-2">
                <span className="badge py-1 px-3 mx-1 mb-2" style={skillStyle}>
                  Git
          ...
          <div className="row mt-5">
            <div className="col-12">
              <a href={resume} target="_blank">
                <p style={{ marginRight: "40px" }}>View Full Résumé <FontAwesomeIcon icon={faArrowRight} /></p>
              </a>
            </div>
          </div>
        </div>
